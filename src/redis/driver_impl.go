...
func (c *clientImpl) PipeScriptAppend(pipeline Pipeline, rcv interface{}, script radix.EvalScript, keys []string, args ...string) Pipeline {
	return append(pipeline, script.FlatCmd(rcv, keys, args))
}
