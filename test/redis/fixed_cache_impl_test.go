...
func testRedis(usePerSecondRedis bool) func(*testing.T) {
	return func(t *testing.T) {
		...
		clientUsed.EXPECT().PipeScriptAppend(gomock.Any(), gomock.Any(), gomock.Any(), "domain_key_value", "domain_key_value:expires", "10", "10", "500", "1", "1234").SetArg(1, []int64{5, 1, 1}).DoAndReturn(pipeScriptAppend)
...
func TestNearLimit(t *testing.T) {
	...
	timeSource.EXPECT().UnixNow().Return(int64(1234)).MaxTimes(3)
	client.EXPECT().PipeScriptAppend(gomock.Any(), gomock.Any(), gomock.Any(), "domain_key5_value5", "domain_key5_value5:expires", "20", "20", "500", "3", "1234").SetArg(1, []int64{17, 1, 1}).DoAndReturn(pipeScriptAppend)
	client.EXPECT().PipeDo(gomock.Any(), gomock.Any()).Return(nil)
	...
	timeSource.EXPECT().UnixNow().Return(int64(1234)).MaxTimes(3)
	client.EXPECT().PipeScriptAppend(gomock.Any(), gomock.Any(), gomock.Any(), "domain_key6_value6", "domain_key6_value6:expires", "8", "8", "500", "2", "1234").SetArg(1, []int64{2, 1, 1}).DoAndReturn(pipeScriptAppend)
	client.EXPECT().PipeDo(gomock.Any(), gomock.Any()).Return(nil)
	...
	timeSource.EXPECT().UnixNow().Return(int64(1234)).MaxTimes(3)
	client.EXPECT().PipeScriptAppend(gomock.Any(), gomock.Any(), gomock.Any(), "domain_key7_value7", "domain_key7_value7:expires", "20", "20", "500", "3", "1234").SetArg(1, []int64{3, 1, 1}).DoAndReturn(pipeScriptAppend)
	client.EXPECT().PipeDo(gomock.Any(), gomock.Any()).Return(nil)
	...
	timeSource.EXPECT().UnixNow().Return(int64(1234)).MaxTimes(3)
	client.EXPECT().PipeScriptAppend(gomock.Any(), gomock.Any(), gomock.Any(), "domain_key8_value8", "domain_key8_value8:expires", "20", "20", "500", "3", "1234").SetArg(1, []int64{1, 1, 0}).DoAndReturn(pipeScriptAppend)
	client.EXPECT().PipeDo(gomock.Any(), gomock.Any()).Return(nil)
	...
	timeSource.EXPECT().UnixNow().Return(int64(1234)).MaxTimes(3)
	client.EXPECT().PipeScriptAppend(gomock.Any(), gomock.Any(), gomock.Any(), "domain_key9_value9", "domain_key9_value9:expires", "20", "20", "500", "7", "1234").SetArg(1, []int64{5, 1, 0}).DoAndReturn(pipeScriptAppend)
	client.EXPECT().PipeDo(gomock.Any(), gomock.Any()).Return(nil)
	...
	timeSource.EXPECT().UnixNow().Return(int64(1234)).MaxTimes(3)
	client.EXPECT().PipeScriptAppend(gomock.Any(), gomock.Any(), gomock.Any(), "domain_key10_value10", "domain_key10_value10:expires", "10", "10", "500", "3", "1234").SetArg(1, []int64{0, 1, 0}).DoAndReturn(pipeScriptAppend)
	client.EXPECT().PipeDo(gomock.Any(), gomock.Any()).Return(nil)
...
func TestOverLimitWithLocalCacheShadowRule(t *testing.T) {
	...
	// Test Over limit stats with local cache
	timeSource.EXPECT().UnixNow().Return(int64(1000000)).MaxTimes(4)
	client.EXPECT().PipeScriptAppend(gomock.Any(), gomock.Any(), gomock.Any(), "domain_key4_value4", "domain_key4_value4:expires", "15", "15", "500", "1", "1000000").Times(0)
...
func TestRedisTracer(t *testing.T) {
	...
	client.EXPECT().PipeScriptAppend(gomock.Any(), gomock.Any(), gomock.Any(), "domain_key_value", "domain_key_value:expires", "10", "10", "500", "1", "1234").SetArg(1, []int64{5, 1, 1}).DoAndReturn(pipeScriptAppend)
	client.EXPECT().PipeDo(gomock.Any(), gomock.Any()).Return(nil)
